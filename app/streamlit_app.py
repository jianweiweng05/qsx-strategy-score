...
COPY = {
    ...
    "zh": {
        ...
        "eyebrow": "免费策略评分器",
        "title": "你的回测是真的吗？",
        "subtitle": "上传收益率、净值或交易日志，几秒生成 0-100 评分、核心指标、过拟合与风险识别、蒙特卡洛模拟、风控叠加预览和分享卡。",
        "subtitle_assets": "资产对比：加密资产、美股与 ETF、全球指数、A 股 ETF、港股、贵金属、能源、债券和外汇。",
        "language": "语言",
        ...
        "custom_help": "可选：带收盘价列的价格 CSV/TSV/Excel。上传后优先使用它。",
        ...
        "asset_skipped": "已跳过资产对比；能力与运气检验将不完整。",
        ...
        "overlay_privacy": "只上传标准化后的每日日期-收益率序列。原始文件、文件名、交易日志、策略代码和账户信息都留在本机。",
        "overlay_online": "使用 QuantScopeX 托管评分服务；这个开源仓库不包含生产风控叠加序列。",
        "overlay_trade_log_note": "风控叠加预览会拒绝含多笔重叠持仓的交易日志。请上传净值曲线或每日收益序列，让预览使用聚合后的策略路径。",
...
FUNNEL_COPY = {
    ...
    "zh": {
        ...
        "results_subtitle": "一页看完健康度、风险、主要问题，以及是否值得测试 QSX 风控叠加预览。",
        "core_metrics": "核心指标",
        "risk_diagnosis": "风险诊断",
        "main_problems": "主要问题",
        "overlay_question": "QSX 风控叠加预览能改善这个策略吗？",
        "overlay_hint": "先免费运行一次托管轻量模拟。开源应用只发送标准化后的每日日期-收益率序列。",
        "advanced_details": "诊断详情",
        "score_label": "策略评分",
        "verdict": "结论",
        "drawdown_risk": "回撤风险",
        ...
        "sample_risk": "样本规模风险",
        "tail_risk": "极端行情风险",
        "mc_source_note": "基于本次上传的收益率序列，在本地使用移动区块自助法计算，不调用风控叠加层或远端接口。",
        "mc_profit_prob": "盈利概率",
        "mc_cagr_range": "年化收益率 5%–95%",
        "mc_tail_dd": "最坏 5% 最大回撤",
        "high": "高",
        "medium": "中",
        "low": "低",
        "no_major_issue": "免费体检未发现明确硬伤。",
        "overlay_primary": "运行免费风控叠加模拟",
    },
    "ja": {
