    ...
    def compact_issue_text(item: dict) -> str:
        ...
        short_by_lang = {
            "en": {
                ...
                "LOW_FREQUENCY": "Few trades — analyze further.",
            ...
            "es": {
                ...
                "LOW_FREQUENCY": "Pocas ops.; analizar más.",
            ...
            "pt-BR": {
                ...
                "LOW_FREQUENCY": "Poucas ops.; analise mais.",
