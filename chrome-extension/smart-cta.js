(function() {
  ...
  const COPY = {
    zh: {
      ...
      evidence: '本次依据',
      secondary: '查看完整专业版尽调',
      overlayTitle: '策略有优势，但回撤风险会限制实盘',
      overlayBody: '先免费运行一次 QSX 加密资产通用风控叠加预览，测试动态仓位控制能否在保留收益的同时降低回撤。',
      overlayButton: '免费测试通用风控叠加层',
      randomTitle: '策略还不能和随机择时清晰区分',
      randomBody: '先别急着优化参数。完整尽调会检查样本外稳定性、HCRI 主场和真实可交易性。',
      randomButton: '查看专业版尽调路径',
      tradeDependencyTitle: '高分成立，但收益集中和回测假设要核验',
      tradeDependencyBody: '这类已平仓交易日志看不到持仓期间的真实逐日盯市回撤。下一步应核验少数大额盈利交易、手续费、滑点、杠杆、小本金和成交容量。',
      tradeDependencyButton: '查看专业版尽调路径',
      dependencyTitle: '收益可能高度依赖持有资产',
      dependencyBody: '下一步应拆分阿尔法收益和贝塔暴露，确认策略贡献没有被牛市或单一资产暴露掩盖。',
      dependencyButton: '查看暴露度诊断',
      lowScoreTitle: '策略还需要先修基本问题',
      lowScoreBody: '先根据免费报告修复主要风险，再决定是否值得测试通用风控叠加层或专业版深度诊断。',
      lowScoreButton: '查看改进方向',
      proTitle: '免费筛查通过，下一步是尽调深水区',
      proBody: '如果准备上实盘，继续检查成本、滑点、极端行情窗口、HCRI 主场和真实逐日盯市回撤。',
      proButton: '查看完整报告',
    },
    en: {
